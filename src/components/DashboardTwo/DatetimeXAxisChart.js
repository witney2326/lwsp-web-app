...
class DatetimeXAxisChart extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            selection: 'one_year',
        ...
        return (
            <div id="chart" className="apexcharts-content">
                <div className="toolbar">
                    ...
                    <button 
                    onClick={()=>this.updateData('one_year')} id="one_year" 
                    className={ (this.state.selection==='one_year' ? 'active' : '')}>
                        1Y
                    </button>

                    <button 
                    onClick={()=>this.updateData('ytd')} id="ytd" 
                    className={ (this.state.selection==='ytd' ? 'active' : '')}>YTD</button>

                    <button onClick={()=>this.updateData('all')} 
                    id="all" 
...
export default DatetimeXAxisChart;