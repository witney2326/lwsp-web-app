...
class CityDeliveryStatusElement extends React.Component {
    state = {
        sideMenu: true
    };
                            ...
                            <div className="card mb-4">
                                <div className="card-body">
                                    <div className="card-header">
                                        ...
                                        <h8 className="card-title"><h8 style={{ color: 'blue' }}><b>Overall OSS Delivery Progress</b></h8></h8>
...
export default CityDeliveryStatusElement;